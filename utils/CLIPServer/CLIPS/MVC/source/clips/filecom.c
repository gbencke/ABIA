...
globle BOOLEAN EnvDribbleOn(
  ...
  char *fileName)
  {
   ...
   if (FileCommandData(theEnv)->DribbleStatusFunction != NULL)
     { (*FileCommandData(theEnv)->DribbleStatusFunction)(TRUE); }
...
globle BOOLEAN EnvDribbleOff(
  void *theEnv)
  {
   ...
   if (FileCommandData(theEnv)->DribbleStatusFunction != NULL)
     { (*FileCommandData(theEnv)->DribbleStatusFunction)(FALSE); }
...
globle int BatchStarCommand(
  void *theEnv)
  {
   ...
   return(BatchStar(theEnv,fileName));
  }
...
globle int BatchStar(
  ...
  char *fileName)
  {
#if (MAC_MPW || MAC_MCW || IBM_MCW) && RUN_TIME
