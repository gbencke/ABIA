...
globle BOOLEAN EnvPutFactSlot(
  ...
  DATA_OBJECT *theValue)
  {
   ...
   if (theDeftemplate->implied)
     {
      ...
      AtomDeinstall(theEnv,theFact->theProposition.theFields[0].type,
      ...
      AtomInstall(theEnv,theFact->theProposition.theFields[0].type,
                  theFact->theProposition.theFields[0].value);
   ...
   AtomDeinstall(theEnv,theFact->theProposition.theFields[whichSlot-1].type,
   ...
   AtomInstall(theEnv,theFact->theProposition.theFields[whichSlot-1].type,
               theFact->theProposition.theFields[whichSlot-1].value);
