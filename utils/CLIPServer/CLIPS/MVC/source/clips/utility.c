...
/***************************************/
   ...
   static BOOLEAN                 AddCPFunction(void *,char *,void (*)(void *),
                                                int,struct cleanupFunction **,BOOLEAN);
   static BOOLEAN                 RemoveCPFunction(void *,char *,struct cleanupFunction **);
