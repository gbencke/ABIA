...
struct entityRecord
  {
   ...
   BOOLEAN (*deleteFunction)(void *,void *);
   BOOLEAN (*evaluateFunction)(void *,void *,DATA_OBJECT *);
...
#define FunctionCall(a,b,c) EnvFunctionCall(GetCurrentEnvironment(),a,b,c)
   ...
   LOCALE void                           SetEvaluationError(void *,BOOLEAN);
   ...
   LOCALE BOOLEAN                        GetFunctionReference(void *,char *,FUNCTION_REFERENCE *);
