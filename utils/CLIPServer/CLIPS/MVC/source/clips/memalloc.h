...
#define SetOutOfMemoryFunction(theEnv,a,b) EnvSetOutOfMemoryFunction(theEnv,a,b)
#else
...
#define SetOutOfMemoryFunction(a,b) EnvSetOutOfMemoryFunction(GetCurrentEnvironment(),a,b)
#endif
   ...
   LOCALE BOOLEAN                        EnvSetConserveMemory(void *,BOOLEAN);
   LOCALE BOOLEAN                        EnvGetConserveMemory(void *);
